...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@pulse/shared/git`, `@pulse/shared/DrainableWorker`) — no barrel index.
