...
Define the long-term server auth architecture for Pulse before first-class remote environments ship.
...
Every privileged surface of the Pulse server must go through the same auth policy engine:
