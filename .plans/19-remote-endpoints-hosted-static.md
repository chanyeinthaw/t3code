...
The tunnel fabric can later be Pipenet-derived, Tailscale-derived, or another reverse tunnel implementation. The rest of Pulse should only see an `AdvertisedEndpoint`.
