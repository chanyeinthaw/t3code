...
const rule = createOxlintRuleHarness("pulse/no-inline-schema-compile");

describe("pulse/no-inline-schema-compile", () => {
  rule.valid(
  ...
  rule.valid(
    "allows pulse helpers that return a precompiled decoder",
    `
      import { Schema } from "effect";
