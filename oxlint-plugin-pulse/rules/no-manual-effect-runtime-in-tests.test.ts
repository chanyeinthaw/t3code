...
const rule = createOxlintRuleHarness("pulse/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("pulse/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("pulse/no-manual-effect-runtime-in-tests");
