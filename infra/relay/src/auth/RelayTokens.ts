...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@pulse/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "pulse-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "pulse-relay-dpop-access+jwt";
