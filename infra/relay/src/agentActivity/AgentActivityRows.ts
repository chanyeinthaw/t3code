import type { RelayAgentActivityState } from "@pulse/contracts/relay";
import { RelayAgentActivityState as RelayAgentActivityStateSchema } from "@pulse/contracts/relay";
...
export class AgentActivityRows extends Context.Service<AgentActivityRows, AgentActivityRowsShape>()(
  "pulse-relay/agentActivity/AgentActivityRows",
) {}
