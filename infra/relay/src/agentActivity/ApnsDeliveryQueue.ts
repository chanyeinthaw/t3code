...
import type { RelayDeliveryResult } from "@pulse/contracts/relay";
...
>()("pulse-relay/agentActivity/ApnsDeliveryQueue/ApnsDeliveryQueueSender") {}
...
export class ApnsDeliveryQueue extends Context.Service<ApnsDeliveryQueue, ApnsDeliveryQueueShape>()(
  "pulse-relay/agentActivity/ApnsDeliveryQueue",
) {}
