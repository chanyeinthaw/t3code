...
describe("merge-update-manifests", () => {
  it("merges arm64 and x64 macOS update manifests into one multi-arch manifest", () => {
    const arm64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Pulse-0.0.4-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Pulse-0.0.4-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Pulse-0.0.4-arm64.zip
sha512: arm64zip
...
`,
    ...
    const x64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Pulse-0.0.4-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Pulse-0.0.4-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Pulse-0.0.4-x64.zip
sha512: x64zip
...
`,
    ...
    assert.deepStrictEqual(
      ...
      [
        "Pulse-0.0.4-arm64.zip",
        "Pulse-0.0.4-arm64.dmg",
        "Pulse-0.0.4-x64.zip",
        "Pulse-0.0.4-x64.dmg",
      ],
    );
  ...
  it("merges arm64 and x64 Windows update manifests into one multi-arch manifest", () => {
    const arm64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Pulse-0.0.4-arm64.exe
    sha512: arm64exe
    size: 125621344
  - url: Pulse-0.0.4-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 131754
path: Pulse-0.0.4-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-07T10:32:14.587Z'
`,
    ...
    const x64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Pulse-0.0.4-x64.exe
    sha512: x64exe
    size: 132000112
  - url: Pulse-0.0.4-x64.exe.blockmap
    sha512: x64blockmap
    size: 138148
path: Pulse-0.0.4-x64.exe
sha512: x64exe
releaseDate: '2026-03-07T10:36:07.540Z'
`,
      "latest-win-x64.yml",
    ...
    assert.deepStrictEqual(
      merged.files.map((file) => file.url),
      [
        "Pulse-0.0.4-arm64.exe",
        "Pulse-0.0.4-arm64.exe.blockmap",
        "Pulse-0.0.4-x64.exe",
        "Pulse-0.0.4-x64.exe.blockmap",
      ],
    );
...
`;
  ...
  it.effect("writes the merged manifest back to the primary path by default", () =>
    Effect.gen(function* () {
      ...
      assert.ok(merged.includes("Pulse-0.0.4-arm64.zip"));
      assert.ok(merged.includes("Pulse-0.0.4-x64.zip"));
...
`,
      ...
      assert.ok(merged.includes("Pulse-0.0.4-arm64.exe"));
      assert.ok(merged.includes("Pulse-0.0.4-x64.exe"));
    }),
  );
