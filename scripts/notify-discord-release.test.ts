...
const latestAnnouncement = {
  ...
  releaseName: "Pulse v1.2.3",
  version: "1.2.3",
  tag: "v1.2.3",
  releaseUrl: new URL("https://github.com/sats-lab/pulse/releases/tag/v1.2.3"),
...
it("builds a prerelease Discord announcement for nightly subscribers", () => {
  assert.deepStrictEqual(
    buildDiscordReleaseAnnouncement({
      ...
      releaseName: "Pulse Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      version: "1.2.4-nightly.20260501.17",
      tag: "v1.2.4-nightly.20260501.17",
      releaseUrl: new URL(
        "https://github.com/sats-lab/pulse/releases/tag/v1.2.4-nightly.20260501.17",
      ),
      timestamp: "2026-05-01T01:41:00.000Z",
    }),
    {
      content:
        "<@&111111111111111111> Prerelease published: Pulse Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      allowed_mentions: {
        roles: ["111111111111111111"],
      },
      embeds: [
        {
          title: "Pulse Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
          url: "https://github.com/sats-lab/pulse/releases/tag/v1.2.4-nightly.20260501.17",
          description: "A new Pulse prerelease is available for nightly testers.",
          color: 0x5865f2,
          fields: [
            {
              name: "Version",
...
it("builds a latest Discord announcement for stable subscribers", () => {
  assert.deepStrictEqual(buildDiscordReleaseAnnouncement(latestAnnouncement), {
    content: "<@&222222222222222222> Latest published: Pulse v1.2.3",
    allowed_mentions: {
    ...
    embeds: [
      {
        title: "Pulse v1.2.3",
        url: "https://github.com/sats-lab/pulse/releases/tag/v1.2.3",
        description: "A new Pulse latest release is available.",
        color: 0x2ecc71,
        fields: [
          {
            name: "Version",
