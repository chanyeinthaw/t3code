...
const workspaceFiles = [
  ...
  "apps/mobile/modules/pulse-markdown-text/package.json",
  "apps/mobile/modules/pulse-review-diff/package.json",
  "apps/mobile/modules/pulse-terminal/package.json",
  "apps/marketing/package.json",
  "infra/relay/package.json",
  "oxlint-plugin-pulse/package.json",
...
files:
  - url: Pulse-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Pulse-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Pulse-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Pulse-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Pulse-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Pulse-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
function writeWindowsManifestFixtures(
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Pulse-9.9.9-smoke.0-arm64.exe
    sha512: arm64exe
    size: 126621344
  - url: Pulse-9.9.9-smoke.0-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 152344
path: Pulse-9.9.9-smoke.0-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-08T10:32:14.587Z'
`,
  );
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Pulse-9.9.9-smoke.0-x64.exe
    sha512: x64exe
    size: 132000112
  - url: Pulse-9.9.9-smoke.0-x64.exe.blockmap
    sha512: x64blockmap
    size: 160112
path: Pulse-9.9.9-smoke.0-x64.exe
sha512: x64exe
releaseDate: '2026-03-08T10:36:07.540Z'
`,
  );
...
const tempRoot = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "pulse-release-smoke-"));
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=Pulse Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "Pulse-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "Pulse-9.9.9-smoke.0-x64.zip",
  ...
  assertContains(
    ...
    "Pulse-9.9.9-smoke.0-arm64.exe",
    "Merged Windows manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedWindowsManifest,
    "Pulse-9.9.9-smoke.0-x64.exe",
