  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Pulse prerelease is available for nightly testers."
          : "A new Pulse latest release is available.",
...
).pipe(Command.withDescription("Post a Pulse release announcement to Discord."));
