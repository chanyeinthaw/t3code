import type { VcsStatusRemoteResult, VcsStatusResult } from "@pulse/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/Pulse.git")).toBe(
      "github.com/t3tools/pulse",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/Pulse.git")).toBe(
      "github.com/t3tools/pulse",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/Pulse")).toBe(
      "github.com/t3tools/pulse",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/Pulse.git")).toBe(
      "gitlab.com/t3tools/platform/pulse",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/Pulse.git")).toBe(
      "gitlab.com/t3tools/platform/pulse",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/Pulse.git"),
    ).toBe("T3Tools/Pulse");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/Pulse.git"),
    ).toBe("T3Tools/Pulse");
  });
});
