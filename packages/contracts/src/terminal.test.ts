...
describe("TerminalOpenInput", () => {
  ...
  it("accepts optional env overrides", () => {
    const parsed = decodeSync(TerminalOpenInput, {
      ...
      terminalId: DEFAULT_TERMINAL_ID,
      cwd: "/tmp/project",
      worktreePath: "/tmp/project/.pulse/worktrees/feature-a",
      cols: 100,
      rows: 24,
      env: {
        PULSE_PROJECT_ROOT: "/tmp/project",
        CUSTOM_FLAG: "1",
      },
    });
    ...
    expect(parsed.worktreePath).toBe("/tmp/project/.pulse/worktrees/feature-a");
  });
    ...
    expect(
      decodes(TerminalEvent, {
        ...
        snapshot: {
          threadId: "thread-1",
          terminalId: DEFAULT_TERMINAL_ID,
          cwd: "/tmp/project/.pulse/worktrees/feature-a",
          worktreePath: "/tmp/project/.pulse/worktrees/feature-a",
          status: "running",
          pid: 1234,
          history: "",
