...
>()("@pulse/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@pulse/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@pulse/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@pulse/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
