...
import { RelayManagedEndpoint } from "@pulse/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@pulse/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@pulse/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
