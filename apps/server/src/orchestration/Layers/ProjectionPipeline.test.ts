...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("pulse-projection-pipeline-test-");
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-base-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-projection-attachments-safe-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("pulse-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "pulse-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "pulse-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
