...
import { SourceControlProviderError, type ChangeRequest } from "@pulse/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PULSE_BITBUCKET_EMAIL and PULSE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
