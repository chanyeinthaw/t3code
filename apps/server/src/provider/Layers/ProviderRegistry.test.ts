...
const TestServerEnvironmentLive = Layer.succeed(ServerEnvironment, {
...
const ProviderRegistryTestLayer = Layer.mergeAll(
  NodeServices.layer,
  ServerSettingsService.layerTest(),
  TestHttpClientLive,
  TestServerEnvironmentLive,
);

it.layer(ProviderRegistryTestLayer)("ProviderRegistry", (it) => {
