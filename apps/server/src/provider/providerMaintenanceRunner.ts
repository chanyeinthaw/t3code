...
>()("@sats-lab/pulse/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Pulse could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Pulse still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
