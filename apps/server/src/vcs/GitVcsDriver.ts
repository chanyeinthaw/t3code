...
export class GitVcsDriver extends Context.Service<GitVcsDriver, GitVcsDriverShape>()(
  "@sats-lab/pulse/vcs/GitVcsDriver",
) {}
...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(gitCommonDir, `pulse-checkpoint-index-${randomUUID()}`);
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Pulse",
        GIT_AUTHOR_EMAIL: "pulse@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Pulse",
        GIT_COMMITTER_EMAIL: "pulse@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `pulse checkpoint ref=${input.checkpointRef}`;
