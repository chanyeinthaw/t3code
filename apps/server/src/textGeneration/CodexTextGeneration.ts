...
import { type CodexSettings, type ModelSelection } from "@pulse/contracts";
...
import { getModelSelectionStringOptionValue } from "@pulse/shared/model";
...
export const makeCodexTextGeneration = Effect.fn("makeCodexTextGeneration")(function* (
  ...
  const writeTempFile = (
    ...
    fileSystem
      .makeTempFileScoped({
        prefix: `pulse-${prefix}-${process.pid}-`,
      })
      .pipe(
