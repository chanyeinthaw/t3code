...
const PIERRE_ICON_SPRITE_ID = "pulse-pierre-file-icon-sprite";

const T3_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="pulse-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="pulse-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="pulse-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="pulse-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="pulse-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="pulse-file-icon-pnpm" viewBox="0 0 32 32">
...
export const T3_PIERRE_ICONS = {
  ...
  byFileName: {
    "package.json": "pulse-file-icon-package-json",
    "tsconfig.json": "pulse-file-icon-tsconfig",
    "agents.md": "pulse-file-icon-agents",
    "claude.md": "pulse-file-icon-claude",
    "readme.md": "pulse-file-icon-readme",
    "pnpm-lock.yaml": "pulse-file-icon-pnpm",
    "pnpm-workspace.yaml": "pulse-file-icon-pnpm",
  },
