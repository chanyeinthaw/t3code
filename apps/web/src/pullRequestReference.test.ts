...
describe("parsePullRequestReference", () => {
  it("accepts GitHub pull request URLs", () => {
    expect(parsePullRequestReference("https://github.com/sats-labs/pulse/pull/42")).toBe(
      "https://github.com/sats-labs/pulse/pull/42",
    );
  });
  ...
  it("accepts gh pr checkout commands with GitHub pull request URLs", () => {
    expect(
      parsePullRequestReference("gh pr checkout https://github.com/sats-labs/pulse/pull/42"),
    ).toBe("https://github.com/sats-labs/pulse/pull/42");
  });
