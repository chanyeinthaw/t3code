import type { EnvironmentId, ServerConfig } from "@pulse/contracts";
...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "pulse:version-mismatch-dismissals:v1";
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Pulse version.",
  };
}
