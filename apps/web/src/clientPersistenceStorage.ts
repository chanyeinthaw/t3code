...
export const CLIENT_SETTINGS_STORAGE_KEY = "pulse:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "pulse:saved-environment-registry:v1";
