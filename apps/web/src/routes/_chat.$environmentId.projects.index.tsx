              ...
              filteredProjects.map((project) => {
                ...
                return (
                  <button
                    key={project.id}
                    type="button"
                    className="group/project-row flex min-w-0 items-center gap-4 border-b border-border/40 px-4 py-3 text-left transition-colors hover:bg-accent/40 focus-visible:bg-accent/40 focus-visible:outline-hidden sm:px-6"
                    onClick={() =>
                      void navigate({
