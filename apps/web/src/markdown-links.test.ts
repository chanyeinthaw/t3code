...
describe("rewriteMarkdownFileUriHref", () => {
  ...
  it("normalizes file uri hrefs for windows drive paths", () => {
    expect(
      rewriteMarkdownFileUriHref(
        "file:///D:/Programme/pulse/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/pulse/apps/web/src/components/chat/OpenInPicker.tsx#L69");
  });

  it("unwraps angle-bracketed file uri hrefs", () => {
    expect(
      rewriteMarkdownFileUriHref(" <file:///D:/Programme/pulse/apps/web/src/markdown-links.ts> "),
    ).toBe("D:/Programme/pulse/apps/web/src/markdown-links.ts");
  });
});
...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("formats tooltip display paths relative to the cwd when possible", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "file:///C:/Users/mike/dev-stuff/pulse/apps/web/src/session-logic.ts#L501",
        "C:/Users/mike/dev-stuff/pulse",
      ),
    ).toMatchObject({
      displayPath: "pulse/apps/web/src/session-logic.ts:501",
  ...
  it("formats tooltip display paths relative to the cwd for slash-prefixed windows paths", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/C:/Users/mike/dev-stuff/pulse/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
        "C:/Users/mike/dev-stuff/pulse",
      ),
    ).toMatchObject({
      displayPath: "pulse/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
  ...
  it("normalizes slash-prefixed windows drive paths before resolving", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "/D:/Programme/pulse/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/pulse/apps/web/src/components/chat/OpenInPicker.tsx:69");
  });

  it("resolves angle-bracketed windows drive paths", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "</D:/Programme/pulse/apps/web/src/components/ChatMarkdown.tsx:1>",
      ),
    ).toBe("D:/Programme/pulse/apps/web/src/components/ChatMarkdown.tsx:1");
  });
