...
import { DEFAULT_UNIFIED_SETTINGS } from "@pulse/contracts/settings";
...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const changedSettingLabels = useMemo(
    () => [
      ...
      ...(settings.timestampFormat !== DEFAULT_UNIFIED_SETTINGS.timestampFormat
        ? ["Time format"]
        : []),
      ...(settings.threadPreviewCount !== DEFAULT_UNIFIED_SETTINGS.threadPreviewCount
        ? ["Visible threads"]
        : []),
  ...
  const restoreDefaults = useCallback(async () => {
    ...
    updateSettings({
      ...
      threadPreviewCount: DEFAULT_UNIFIED_SETTINGS.threadPreviewCount,
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Pulse looks across the app."
          resetAction={
            theme !== "system" ? (
