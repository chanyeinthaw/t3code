...
export const ChatComposer = memo(function ChatComposer(
  ...
  const composerProviderControls = useMemo(
    () => ({
      ...
      supportedAccessModes: getProviderSupportedAccessModes(
        providerStatuses,
        selectedProvider,
      ),
    }),
  ...
  const effectiveRuntimeMode =
    composerProviderControls.supportedAccessModes.includes(runtimeMode)
      ? runtimeMode
  ...
  const composerMenuItems = useMemo<ComposerCommandItem[]>(() => {
    ...
    if (composerTrigger.kind === "slash-command") {
      const canToggleInteractionMode =
        selectedProviderStatusWithDiscovery?.showInteractionModeToggle !==
        false;
  ...
  return (
    ...
    >
      <div
        className={cn(
          "group rounded-[27px] p-px transition-colors duration-200",
      ...
      >
        <div
          ...
          className={cn(
            "rounded-[25px] border bg-background/60 backdrop-blur-sm transition-colors duration-200",
            isDragOverComposer
                    ...
                    >
                      ...
                      {nonPersistedComposerImageIdSet.has(image.id) && (
                        <Tooltip>
                          ...
                          >
                            Draft attachment could not be saved locally and may
                ...
                {isComposerFooterCompact ? (
                  <CompactComposerControlsMenu
                    ...
                    supportedAccessModes={
                      composerProviderControls.supportedAccessModes
                    }
