...
import { isProviderDriverKind, ProviderDriverKind } from "@pulse/contracts";
import type { ThreadId, TurnId } from "@pulse/contracts";
import * as Schema from "effect/Schema";
import { resolveModelSlugForProvider } from "@pulse/shared/model";
...
export interface EnvironmentState {
  ...
  // createThreadDetailManager from @pulse/client-runtime. New shared behavior
