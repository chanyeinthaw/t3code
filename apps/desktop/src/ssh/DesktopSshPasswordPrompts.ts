import type { DesktopSshPasswordPromptRequest } from "@pulse/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@pulse/contracts";
import type { SshPasswordRequest } from "@pulse/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "Pulse window is not available for SSH authentication.";
...
>()("@pulse/desktop/ssh/DesktopSshPasswordPrompts") {}
