...
>()("@pulse/desktop/backend/DesktopBackendConfiguration") {}
...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "PULSE_NO_BROWSER",
  "PULSE_HOST",
  "PULSE_DESKTOP_WS_URL",
  "PULSE_DESKTOP_LAN_ACCESS",
  "PULSE_DESKTOP_LAN_HOST",
  "PULSE_DESKTOP_HTTPS_ENDPOINTS",
  "PULSE_TAILSCALE_SERVE",
  "PULSE_TAILSCALE_SERVE_PORT",
] as const;
...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's PULSE_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus PULSE_HOME (dev-runner
  // exports the Windows-side base dir for the primary; if it leaks into
  // the WSL backend the Linux side ends up sharing C:\Users\...\.pulse via
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus PULSE_HOME; pass it
