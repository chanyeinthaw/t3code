import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@pulse/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@pulse/shared/observability";
...
>()("@pulse/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
