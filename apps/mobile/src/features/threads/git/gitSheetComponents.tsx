...
export function SheetActionButton(props: {
  ...
  return (
    ...
    >
      ...
      <Text
        className="text-[12px] font-pulse-bold uppercase"
...
export function MetaCard(props: { readonly label: string; readonly value: string }) {
  return (
    <View className="rounded-[18px] border border-border bg-card px-4 py-3">
      <Text
        className="text-foreground-muted text-[11px] font-pulse-bold uppercase"
  ...
  return (
    ...
    >
      ...
      <View className="flex-1 gap-0.5">
        <Text className="text-foreground text-[16px] font-pulse-bold">{props.title}</Text>
        {props.subtitle ? (
