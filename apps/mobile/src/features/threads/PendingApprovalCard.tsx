import type { ApprovalRequestId, ProviderApprovalDecision } from "@pulse/contracts";
...
export function PendingApprovalCard(props: PendingApprovalCardProps) {
  return (
    <View className="gap-2.5 rounded-[20px] border border-neutral-200 bg-neutral-100/80 p-4 dark:border-white/6 dark:bg-neutral-900/80">
      <Text className="font-pulse-bold text-[11px] uppercase tracking-[1.1px] text-sky-700 dark:text-sky-300">
        Approval needed
      </Text>
      <Text className="font-pulse-bold text-lg text-neutral-950 dark:text-neutral-50">
      ...
      <View className="flex-row flex-wrap gap-2.5">
        ...
        >
          <Text className="font-pulse-extrabold text-sm text-white">Allow once</Text>
        </Pressable>
        <Pressable
        ...
        >
          <Text className="font-pulse-bold text-sm text-neutral-950 dark:text-neutral-50">
            Allow session
          </Text>
        </Pressable>
        <Pressable
        ...
        >
          <Text className="font-pulse-bold text-sm text-rose-700 dark:text-rose-300">Decline</Text>
        </Pressable>
      </View>
    </View>
  );
