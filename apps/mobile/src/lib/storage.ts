...
import { EnvironmentId, OrchestrationShellSnapshot } from "@pulse/contracts";
...
const CONNECTIONS_KEY = "pulse.connections";
const PREFERENCES_KEY = "pulse.preferences";
const AGENT_AWARENESS_DEVICE_ID_KEY = "pulse.agent-awareness.device-id";
