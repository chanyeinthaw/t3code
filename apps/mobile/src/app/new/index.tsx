...
import type { EnvironmentId, ProjectId } from "@pulse/contracts";
      ...
      >
        {items.length === 0 ? (
          <View collapsable={false} className="items-center gap-3 rounded-[24px] bg-card px-6 py-8">
            ...
            <Text className="text-center text-[17px] font-pulse-bold text-foreground">
                  ...
                  >
                    <View className="flex-row items-center justify-between gap-3">
                      ...
                      <View className="flex-1">
                        <Text className="text-[16px] leading-[21px] font-pulse-bold">
                          {item.title}
                        </Text>
                      </View>
                      <SymbolView
