...
const customIcons = {
  agents: "pulse-file-icon-agents",
  claude: "pulse-file-icon-claude",
  package: "pulse-file-icon-package-json",
  pnpm: "pulse-file-icon-pnpm",
  readme: "pulse-file-icon-readme",
  tsconfig: "pulse-file-icon-tsconfig",
};
